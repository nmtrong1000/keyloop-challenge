...
/**
 * Runs against `npm run dev` by default. MSW's instrumentation.ts and
 * MockingProvider now start in every environment, including production —
 * `npm run build && npm run start` serves mocked data too.
 *
